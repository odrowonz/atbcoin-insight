...
void SignVerifyMessageDialog::on_signMessageButton_SM_clicked()
{
    ...
    if (!addr.IsValid())
    {
        ui->statusLabel_SM->setStyleSheet("QLabel { color: #f6e395; }");
    ...
    ui->statusLabel_SM->setStyleSheet("QLabel { color: #a3f642; }");
...
void SignVerifyMessageDialog::on_verifyMessageButton_VM_clicked()
{
    ...
    if (!addr.IsValid())
    {
        ui->statusLabel_VM->setStyleSheet("QLabel { color: #f6e395; }");
    ...
    ui->statusLabel_VM->setStyleSheet("QLabel { color: #a3f642; }");
