 ...
 * После этого должна создаваться и отправляться в сеть транзакция, имеющая аутпут с кол-вом монет, введенным пользователем и scriptPubKey имеющим вид OP_HASH160 ripemd160(ключевое слово) OP_EQUAL.
 * Кнопку вызова формы можно поместить в меню.
 * ------------------------------------------------------------------------------------------------
 * Создать вкладку на главном экране кошелька, в которой будут отображаться
 * созданные бонусные коды (ключевые слова) + инфо(хэш транзакции + номер аутпута в котором он был создан).
*/
#include <QDialog>
